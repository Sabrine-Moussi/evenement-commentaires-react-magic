...
const AdminSidebar = () => {
  ...
  // Aider à déterminer la page active
  const isActive = (path: string) => location.pathname === path;
  
  // Maintenir ouvert le groupe qui contient la page active
  const dashboardActive = location.pathname === "/admin";
  const eventsActive = location.pathname.startsWith("/admin/events");
  const commentsActive = location.pathname.startsWith("/admin/comments");
  const settingsActive = location.pathname.startsWith("/admin/settings");

  // États pour les groupes de menu
  const [eventsOpen, setEventsOpen] = useState(eventsActive);
  const [commentsOpen, setCommentsOpen] = useState(commentsActive);
  ...
  return (
    <div className={cn(
      ...
      {/* Logo */}
      <div className="py-4 px-2 mb-2 flex justify-center items-center">
        {isSidebarCollapsed ? (
          <svg
      ...
      <div className="px-3 py-2 space-y-1">
        ...
        <div className="py-2">
          ...
          {(eventsOpen || isSidebarCollapsed) && (
            <div className="pl-4 mt-1 space-y-1">
              <NavLink to="/admin/events" end className={getNavClass}>
                {!isSidebarCollapsed ? (
              ...
              <NavLink to="/admin/events/create" className={getNavClass}>
                {!isSidebarCollapsed ? (
        ...
        <div className="py-2">
          ...
          {(commentsOpen || isSidebarCollapsed) && (
            <div className="pl-4 mt-1 space-y-1">
              <NavLink to="/admin/comments" end className={getNavClass}>
                {!isSidebarCollapsed ? (
              ...
              <NavLink to="/admin/comments/moderation" className={getNavClass}>
                {!isSidebarCollapsed ? (
